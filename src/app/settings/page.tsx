...
import { ArrowLeft, Shield, Cpu, Globe, Key, CheckCircle, XCircle } from "lucide-react";
      ...
      <div className="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
        ...
        <div className="mb-8">
          ...
          <p className="text-gray-400 text-sm sm:text-base">
            Conecta con OpenAI, NVIDIA NIM, Ollama u otro proveedor compatible con la API de OpenAI para generar mensajes contextuales.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 mb-8">
          <div className="bg-gray-800/50 rounded-xl p-4 border border-gray-700/50 text-center">
            ...
            <p className="text-xs text-gray-400 font-medium">OpenAI</p>
            <p className="text-[10px] text-gray-500 mt-0.5">api.openai.com/v1</p>
          </div>
          <div className="bg-gray-800/50 rounded-xl p-4 border border-gray-700/50 text-center">
            <div className="text-2xl mb-1">🟣</div>
            <p className="text-xs text-gray-400 font-medium">NVIDIA NIM</p>
            <p className="text-[10px] text-gray-500 mt-0.5">integrate.api.nvidia.com/v1</p>
          </div>
          <div className="bg-gray-800/50 rounded-xl p-4 border border-gray-700/50 text-center">
            <div className="text-2xl mb-1">🦙</div>
            <p className="text-xs text-gray-400 font-medium">Ollama</p>
            <p className="text-[10px] text-gray-500 mt-0.5">localhost:11434/v1</p>
          </div>
        </div>
        ...
        <div className="bg-gray-800/60 rounded-2xl border border-gray-700/50 shadow-xl overflow-hidden">
          <div className="p-6 sm:p-8 space-y-6">
            ...
            {validationResult && (
              <div
                className={`flex items-center gap-3 p-4 rounded-xl text-sm transition-all duration-300 animate-fade-in ${
            ...
            {/* Saved notification */}
            {saved && (
              <div className="flex items-center gap-3 p-4 rounded-xl text-sm bg-emerald-900/30 border border-emerald-700/50 text-emerald-300 animate-fade-in">
                <CheckCircle size={18} className="shrink-0" />
        ...
        <div className="mt-8 p-4 sm:p-6 bg-gray-800/30 rounded-xl border border-gray-700/30">
          ...
          <ul className="space-y-2 text-xs text-gray-500">
            <li className="flex items-start gap-2">
              ...
              Ingresa la URL base de tu proveedor de IA compatible con OpenAI
            </li>
            <li className="flex items-start gap-2">
              <span className="text-indigo-400 mt-0.5">2.</span>
              Agrega tu API Key (se guarda solo en tu navegador)
            </li>
            <li className="flex items-start gap-2">
